      ...
      <div className="page-inner animate-in">
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            <a
              href= "https://drive.google.com/file/d/1dyZnlBE4O2wkWMS1Nffzyw5dbyTNtTnN/view?usp=sharing"
              //"https://drive.google.com/uc?export=download&id=1dyZnlBE4O2wkWMS1Nffzyw5dbyTNtTnN"
              target="_blank"
